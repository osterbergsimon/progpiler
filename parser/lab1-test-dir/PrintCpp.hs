...
instance Print Stm where
  prt i e = case e of
   ...
   SDecl type' id -> prPrec i 0 (concatD [prt 0 type' , prt 0 id , doc (showString ";")])
   SDecls type' id ids -> prPrec i 0 (concatD [prt 0 type' , prt 0 id , doc (showString ",") , prt 0 ids , doc (showString ";")])
   ...
   SDoWhile stm exp -> prPrec i 0 (concatD [doc (showString "do") , prt 0 stm , doc (showString ";") , doc (showString "while") , doc (showString "(") , prt 0 exp , doc (showString ")")])
   ...
   SFor exp0 exp1 exp stm -> prPrec i 0 (concatD [doc (showString "for") , doc (showString "(") , prt 0 exp0 , doc (showString ";") , prt 0 exp1 , doc (showString ";") , prt 0 exp , doc (showString ")") , prt 0 stm])
   STypedef exp id -> prPrec i 0 (concatD [doc (showString "typedef") , prt 0 exp , prt 0 id])
   SStruct id stms -> prPrec i 0 (concatD [doc (showString "struct") , prt 0 id , doc (showString "{") , prt 0 stms , doc (showString "}") , doc (showString ";")])
...
instance Print Exp where
  prt i e = case e of
   ...
   EPStr1 exp0 exp -> prPrec i 14 (concatD [prt 15 exp0 , doc (showString ".") , prt 14 exp])
   EPStr2 exp0 exp -> prPrec i 14 (concatD [prt 15 exp0 , doc (showString "->") , prt 14 exp])
   ...
   ETempi id types -> prPrec i 16 (concatD [prt 0 id , doc (showString "<") , prt 0 types , doc (showString ">")])
   QC exp0 exp -> prPrec i 16 (concatD [prt 17 exp0 , doc (showString "::") , prt 17 exp])
