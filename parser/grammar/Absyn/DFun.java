...
public class DFun extends Def {
  ...
  public <R,A> R accept(grammar.Absyn.Def.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof grammar.Absyn.DFun) {
      grammar.Absyn.DFun x = (grammar.Absyn.DFun)o;
